...
<p><?php printf( __( "Hi there. Your recent order on %s has been completed. Your order details are shown below for your reference:", 'look' ), get_option( 'blogname' ) ); ?></p>
...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #111;" border="1" bordercolor="#111">
	...
	<tbody>
		<?php echo (string)$order->email_order_items_table( true, false, true ); ?>
	</tbody>
	<tfoot>
		<?php
