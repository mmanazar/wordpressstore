            ...
            if(isset($tmp[$option])  || $option == 'null')
            {
                ...
                foreach ( $attachment_ids as $attachment_id ) {
                    ...
                    if(look_get_option('product_image_zoom')  == 1)
                    {
                        ...
                        $classes[] = 'zoom';
                        $images .= apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<a href="%s" class="%s img-thumb" title="%s">%s</a>', $image_link, $image_class, $image_title, $image ), $attachment_id, $productId, $image_class );
